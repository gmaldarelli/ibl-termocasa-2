...
public class IBLTermocasaTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<IBLTermocasaTenantDatabaseMigrationHandler> _logger;

    public IBLTermocasaTenantDatabaseMigrationHandler(
        IEnumerable<IIBLTermocasaDbSchemaMigrator> dbSchemaMigrators,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<IBLTermocasaTenantDatabaseMigrationHandler> logger)
    {
    ...
    public async Task HandleEventAsync(TenantCreatedEto eventData)
    {
        await MigrateAndSeedForTenantAsync(
            eventData.Id,
            eventData.Properties.GetOrDefault("AdminEmail") ?? IBLTermocasaConsts.AdminEmailDefaultValue,
            eventData.Properties.GetOrDefault("AdminPassword") ?? IBLTermocasaConsts.AdminPasswordDefaultValue
        );
    }
