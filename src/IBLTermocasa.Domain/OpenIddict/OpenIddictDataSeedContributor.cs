...
namespace IBLTermocasa.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("IBLTermocasa") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "IBLTermocasa", DisplayName = "IBLTermocasa API", Resources = { "IBLTermocasa" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["IBLTermocasa_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["IBLTermocasa_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        var webPublicTieredClientId = configurationSection["IBLTermocasa_Web_Public_Tiered:ClientId"];
        if (!webPublicTieredClientId.IsNullOrWhiteSpace())
        {
            var webPublicTieredRootUrl = configurationSection["IBLTermocasa_Web_Public_Tiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["IBLTermocasa_Web_Public_Tiered:ClientSecret"] ?? "1q2w3e*",
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["IBLTermocasa_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["IBLTermocasa_Swagger:RootUrl"]?.TrimEnd('/');
