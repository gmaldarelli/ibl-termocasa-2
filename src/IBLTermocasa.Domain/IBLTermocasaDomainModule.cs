        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<IBLTermocasaResource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<IBLTermocasaResource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
