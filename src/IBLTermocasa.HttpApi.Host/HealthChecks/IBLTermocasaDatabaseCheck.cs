...
public class IBLTermocasaDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public IBLTermocasaDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
