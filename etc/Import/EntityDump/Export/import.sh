mongoimport --uri mongodb+srv://tcp-app-user:TKfQNWDtdLeoQYx5@tpc-db-dev.trgnsi9.mongodb.net/?retryWrites=true&w=majority&appName=tpc-db-dev --db Default --collection AppBillOfMaterials --file AppBillOfMaterials.json               
mongoimport --uri "mongodb+srv://tcp-app-user:TKfQNWDtdLeoQYx5@tpc-db-dev.trgnsi9.mongodb.net/?retryWrites=true&w=majority&appName=tpc-db-dev" --db Default --collection AppCatalogs --file AppCatalogs.json                             
